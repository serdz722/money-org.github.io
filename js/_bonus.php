...
$hide_form = false;
	...
	if($db->FetchRow() == 0){
		...
		if(isset($_POST["bonus"])){
			...
			echo "<center><font color = 'white'><b>На Ваш счет для покупок зачислен бонус в размере {$sum} Золота</b></font></center><BR />";
...
<?PHP 
	...
	}else echo "<center><font color = 'white'><b>Вы уже получали бонус за последние 24 часа</b></font></center><BR />"; ?>
...
<table class="table" align="center" border="0" cellpadding="3" cellspacing="0" width="99%">
  ...
  <tr>
    <td colspan="5" align="center"><h4><font color = white>Последние 50 бонусов</font></h4></td>
    </tr>
  <tr>

...
1 место - 50% от общего банка [<?=($amount_lottery * $num_bil) * 0.5; ?> Золота]. <BR />
2 место - 25% от общего банка [<?=($amount_lottery * $num_bil) * 0.25; ?> Золота]. <BR />
3 место - 20% от общего банка [<?=($amount_lottery * $num_bil) * 0.2; ?> Золота]. <BR />
Остальные 5% составляют комиссию системы.
<BR />
<u>Стоимость билета = <?=$amount_lottery; ?> Золота</u>.
<BR />
<br>

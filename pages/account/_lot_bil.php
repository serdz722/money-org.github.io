	...
	if(isset($_POST["set_lottery"])){
		...
		if($db->FetchRow() >= $amount_lottery){
			...
			if( ($lid % $num_bil) == 0){
				...
				echo "<center><b><font color='green'>Ваш билет выигрышный. Вам зачислено {$add_m} САХАРА.</font></b></center><BR />";
...
<input type="submit" name="set_lottery" value="НАНЯТЬ билет" style="padding:7px;" />
</form>
</center>

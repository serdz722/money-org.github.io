...
if(isset($_GET["sel"])){
	...
	switch($smenu){
		...
		case "404": include("pages/_404.php"); break; // Страница ошибки
                ...
                case "jobs": include("pages/admin/_gardener.php"); break; // Садовник
...
case "pay_systems": include("pages/admin/_pay_systems.php"); break; // История обмена в обменнике
...
case "payments_req_list": include("pages/admin/_payments_req_list.php"); break; // Истрия выплат Payeeer
		...
		case "adm": include("pages/admin/_adm.php"); break; // Видео
                case "youtube": include("pages/admin/_youtube.php"); break; // Видео
	# Страница ошибки

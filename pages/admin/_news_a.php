...
<div class="col-md-8">								<div class="s-bk-lf">
									<div class="title">Новости редактирование</div>
								</div>
								<div class="silver-bk"><br>
<BR />
<center><a href = "/?menu=tvorojok&sel=news" class="stn">Список новостей</a> || <a href = "/?menu=tvorojok&sel=news&add" class="stn">Добавить новость</a></center>
<BR />
...
<b>Новость:</b><BR />
<textarea name="ntext" cols="78" rows="25"><?=(isset($_POST["ntext"])) ? htmlspecialchars($_POST["ntext"]) : false; ?></textarea><BR />
<center><input type="submit" class="btn_in" value="Сохранить" /></center>
<?PHP
...
if($db->NumRows() != 1){ echo "<center><b>Новость с таким ID не найдена</b></center><BR />"; return;}
	...
	$db->Query("UPDATE db_news SET title = '$title', news = '".mysql_real_escape_string($text)."' WHERE id = '$idr'");
...
<?PHP
	...
	<input type="submit" class="btn_in" value="Удалить" />
	</form>
	</td>
  	</tr>
	<?PHP

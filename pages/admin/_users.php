...
$string = ($type == "-") ? "У пользователя снято {$sum} Поинтов" : "Пользователю добавлено {$sum} Поинтов";
...
<table width="100%" border="0">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Поинтов (Покупки):</td>
    <td width="200" align="center"><?=sprintf("%.2f",$data["money_b"]); ?></td>
  </tr>
  
  <tr>
    <td style="padding-left:10px;">Поинтов (Вывод):</td>
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">КУБКОВ на балансе (ВАЗ 2101):</td>
    <td width="200" align="center"><?=$data["a_b"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">КУБКОВ на балансе (ВАЗ 2114):</td>
    <td width="200" align="center"><?=$data["b_b"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">КУБКОВ на балансе (Subaru):</td>
    <td width="200" align="center"><?=$data["c_b"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">КУБКОВ на балансе (BMW):</td>
    <td width="200" align="center"><?=$data["d_b"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">КУБКОВ на балансе (Volvo):</td>
    <td width="200" align="center"><?=$data["e_b"]; ?></td>
  </tr>    <tr>
    <td style="padding-left:10px;">КУБКОВ на балансе (Audi):</td>
    <td width="200" align="center"><?=$data["f_b"]; ?></td>
  </tr>
    <tr bgcolor="#efefef">
    <td style="padding-left:10px;">КУБКОВ на балансе (Opel):</td>
    <td width="200" align="center"><?=$data["i_b"]; ?></td>
  </tr>    <tr>
    <td style="padding-left:10px;">КУБКОВ на балансе (Grand Cherokee):</td>
    <td width="200" align="center"><?=$data["k_b"]; ?></td>
  </tr>    <tr bgcolor="#efefef">
    <td style="padding-left:10px;">КУБКОВ на балансе (Chevrolet):</td>
    <td width="200" align="center"><?=$data["l_b"]; ?></td>
  </tr>    <tr>
    <td style="padding-left:10px;">КУБКОВ на балансе (Lamborghini):</td>
    <td width="200" align="center"><?=$data["m_b"]; ?></td>
  </tr>  
  
  <tr>
    <td style="padding-left:10px;">ВАЗ 2101:</td>
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">ВАЗ 2114:</td>
    <td width="200" align="center">
  ...
  <tr>
    <td style="padding-left:10px;">Subaru:</td>
    <td width="200" align="center">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">BMW:</td>
    <td width="200" align="center">
  ...
  <tr>
    <td style="padding-left:10px;">Volvo:</td>
    <td width="200" align="center">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Audi:</td>
    <td width="200" align="center">
    ...
    <td style="padding-left:10px;">Opel:</td>
    <td width="200" align="center">
		...
		<table width="100%" border="0">
		  <tr>
			<td>
			<form action="" method="post">
				<input type="hidden" name="set_tree" value="i_t" />
				<input type="hidden" name="type" value="1" />
				<input type="submit" value="-1" />
			</form>
			</td>
			<td align="center"><?=$data["i_t"]; ?> шт.</td>
			<td>
			<form action="" method="post">
				<input type="hidden" name="set_tree" value="i_t" />
				<input type="hidden" name="type" value="2" />
    ...
    <td style="padding-left:10px;">Grand Cherokee:</td>
    <td width="200" align="center">
    ...
    <td style="padding-left:10px;">Chevrolet:</td>
    <td width="200" align="center">
    ...
    <td style="padding-left:10px;">Lamborghini:</td>
    <td width="200" align="center">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Собрано за все время (1 КУБКОВ):</td>
    <td width="200" align="center"><?=$data["all_time_a"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Собрано за все время (2 КУБКОВ):</td>
    <td width="200" align="center"><?=$data["all_time_b"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Собрано за все время (3 КУБКОВ):</td>
    <td width="200" align="center"><?=$data["all_time_c"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Собрано за все время (4 КУБКОВ):</td>
    <td width="200" align="center"><?=$data["all_time_d"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Собрано за все время (5 КУБКОВ):</td>
    <td width="200" align="center"><?=$data["all_time_e"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Собрано за все время (6 КУБКОВ):</td>
    <td width="200" align="center"><?=$data["all_time_f"]; ?></td>
  </tr>  
  
  <tr>  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Собрано за все время (7 КУБКОВ):</td>
    <td width="200" align="center"><?=$data["all_time_i"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Собрано за все время (8 КУБКОВ):</td>
    <td width="200" align="center"><?=$data["all_time_k"]; ?></td>
  </tr>  <tr>  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Собрано за все время (9 КУБКОВ):</td>
    <td width="200" align="center"><?=$data["all_time_l"]; ?></td>
  </tr>  <tr>
    <td style="padding-left:10px;">Собрано за все время (10 КУБКОВ):</td>
    <td width="200" align="center"><?=$data["all_time_m"]; ?></td>
  </tr>
  <tr>    <td style="padding-left:10px;">Referer:</td>
...
?>
<form action="/?menu=tvorojok&sel=users&search" method="post">
...
$search = $_POST["sear"];
$db->Query("SELECT *, (db_users_b.a_t + db_users_b.b_t + db_users_b.c_t + db_users_b.d_t + db_users_b.e_t + db_users_b.f_t + db_users_b.i_t + db_users_b.k_t + db_users_b.l_t + db_users_b.m_t) all_trees, (db_users_b.money_b + db_users_b.money_p) all_serebro 
...
}else $db->Query("SELECT *, (db_users_b.a_t + db_users_b.b_t + db_users_b.c_t + db_users_b.d_t + db_users_b.e_t + db_users_b.f_t + db_users_b.i_t + db_users_b.k_t + db_users_b.l_t + db_users_b.m_t) all_trees, (db_users_b.money_b + db_users_b.money_p) all_serebro 
...
<table cellpadding='3' cellspacing='0' border='0' bordercolor='#336633' align='center' width="99%">
  <tr bgcolor="#efefef">
    <td align="center" width="50" class="m-tb"><a href="/?menu=tvorojok&sel=users&sort=0" class="stn-sort">ID</a></td>
    <td align="center" class="m-tb"><a href="/?menu=tvorojok&sel=users&sort=1" class="stn-sort">User</a></td>
    <td align="center" width="90" class="m-tb"><a href="/?menu=tvorojok&sel=users&sort=2" class="stn-sort">САХАРА</a></td>
	<td align="center" width="75" class="m-tb"><a href="/?menu=tvorojok&sel=users&sort=3" class="stn-sort">Деревьев</a></td>
	<td align="center" width="100" class="m-tb"><a href="/?menu=tvorojok&sel=users&sort=4" class="stn-sort">Зарегистрирован</a></td>
  </tr>
...
<?PHP
    ...
    <td align="center"><a href="/?menu=tvorojok&sel=users&edit=<?=$data["id"]; ?>" class="stn"><?=$data["user"]; ?></a></td>
...
$all_pages = $db->FetchRow();
	...
	echo "<BR /><center>".$nav->Navigation(10, $page, ceil($all_pages / 100), "/?menu=tvorojok&sel=users&sort={$sort_b}&page="), "</center>";

...
if(isset($_POST["admin"])){
	...
	if($items_per_coin < 1 OR $items_per_coin > 50000){
		$errors = false; echo "<center><font color = 'red'><b>Сколько АРТЕФАКТОВ = 1 Золота, должно быть от 1 до 50000</b></font></center><BR />"; 
	}
	
	if($tomat_in_h < 5 OR $straw_in_h < 5 OR $pump_in_h < 5 OR $peas_in_h < 5 OR $pean_in_h < 5){
	...
	if($amount_tomat_t < 1 OR $amount_straw_t < 1 OR $amount_pump_t < 1 OR $amount_peas_t < 1 OR $amount_pean_t < 1){
		$errors = false; echo "<center><font color = 'white'><b>Минимальная стоимость Машины не должна быть менее 1го Золота</b></font></center><BR />"; 
	}
...
<table width="100%" border="0">
  ...
  <tr>
    <td><b>Стоимость 1 RUB (Золота):</b></td>
